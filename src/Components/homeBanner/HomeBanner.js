          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="banner-content">
                ...
                >
                  Transform Your <br /> Future with vvGrad
                </h1>
                <p
                  data-sal-delay="200"
                  data-sal="slide-up"
                ...
                >
                  Join the next generation of learners, professionals, and
                  achievers. Gain world-class skills, explore global education,
                  and unlock opportunities with industry-ready programs.
                </p>

                <div className="links">
                  <Link to="/">Skill Development</Link>
                  <Link to="/">Study Abroad </Link>
                  <Link to="/">Career Preparation</Link>
                </div>
                ...
                >
                  <button
                    className="btn_primary mt-5 me-2"
                    onClick={handleScroll}
                  >
                    Explore Programm <i class="fas fa-arrow-right"></i>
                  </button>
                  <Link className="btn_border mt-5 " to="contact-us">
                ...
                >
                  <div className="inner">
                    <div className="media d-flex">
                      <div className="thumb">
                        {/* <img src={author_sms} alt="Images" /> */}
                      </div>
                      <div className="content">
                        <span>250+</span> Best Companies
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner">
                    <div className="media d-flex">
                      ...
                      <div className="content">
                        <span>100%</span> Satisfied Students
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="container-fluid">
          <div class="features-grid-wrap">
            <div class="features-box features-style-2 edublink-svg-animate">
              ...
              <div class="content">
                <h5 class="title">150+ IRC Certifications</h5>
              </div>
            </div>
            <div class="features-box features-style-2 edublink-svg-animate">
              <div class="icon">
              ...
              <div class="content">
                <h5 class="title">
                  Top Notch Instructor (IIT, IIM, Ex-Company)
                </h5>
              </div>
            </div>
            <div class="features-box features-style-2 edublink-svg-animate">
              ...
              <div class="content">
                <h5 class="title">Career Support and Placement Assistance</h5>
              </div>
            </div>
            <div class="features-box features-style-2 edublink-svg-animate">
              <div class="icon">
              ...
              <div class="content">
                <h5 class="title">3000+ Members</h5>
              </div>
            </div>
          </div>
        </div>
