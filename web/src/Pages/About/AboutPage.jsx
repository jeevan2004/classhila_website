    ...
    <>
      <div className="about_top">
        <div className="container">
          ...
          <p>
            Classhila is an innovative educational platform designed to empower
            students in India with affordable and inclusive preparation for
            competitive exams. We provide personalized learning paths, expert
            guidance, and smart resources to help students reach their full
            potential. With a commitment to accessibility and quality, Classhila
            strives to bridge the gap between students and their career
            aspirations by offering tailored support and comprehensive exam
            coverage.
          </p>
        </div>
      </div>
